...
| `v1.2` | Final v1 closure / v1 最终收口 | Contains no `v1-M12`; it is released only after every v1-M10/v1-M11 exit gate is evidenced / 不新增 `v1-M12`；仅在 v1-M10/v1-M11 所有门禁留证后发布 |
