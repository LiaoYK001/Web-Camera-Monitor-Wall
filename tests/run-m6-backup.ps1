...
$OriginalHash = (Get-FileHash -Algorithm SHA256 -LiteralPath (Join-Path $ConfigRoot 'scene.json')).Hash
...
Write-Host 'M6 backup creation, checksum, permissions, confirmation, atomic restore, corruption rejection, validation, and redaction acceptance passed.'
