...
The latest official release is **v3.2**, tagged at `5ab5da0fa4d2ac67af2ac52c7ee3d64f75ae82cc`. The user's subsequent decision promotes today's existing image to `v3.2` and `latest`, superseding the historical snapshot-only decision below. The unchanged image digest is `sha256:1bbb0c2608c977b2e04386846dcb11674d9f6996a4c8e0b01bb6f1be58999953`. Subsequent development will use this baseline; no next version is started here.
...
[v3.2 正式发布 / Official release](https://github.com/LiaoYK001/Web-Camera-Monitor-Wall/releases/tag/v3.2)
